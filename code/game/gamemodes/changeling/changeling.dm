...
/datum/game_mode/changeling
	...
	protected_jobs = list("Head of Personnel", "Chief Engineer", "Research Director", "Chief Medical Officer", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Brig Physician", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
	protected_species = list("Machine", "Slime People", "Phorosian")
	required_players = 15
	required_enemies = 1
