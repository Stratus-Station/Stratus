...
/obj/machinery/computer/mecha/Topic(href, href_list)
	...
	if(href_list["send_message"])
		var/obj/item/mecha_parts/mecha_tracking/MT = tfilter.getObj("send_message")
	...
	if(href_list["shock"])
		var/obj/item/mecha_parts/mecha_tracking/MT = tfilter.getObj("shock")
		MT.shock()

	if(href_list["get_log"])
		var/obj/item/mecha_parts/mecha_tracking/MT = tfilter.getObj("get_log")
