...
/obj/item/device/radiojammer/improvised
	...
	radius = 5
	icon = 'icons/baysphere/obj/assemblies/new_assemblies.dmi'
	icon_state_active = "improvised_jammer_active"
	icon_state_inactive = "improvised_jammer_inactive"


/obj/item/device/radiojammer/improvised/New(var/obj/item/device/assembly_holder/incoming_holder, var/obj/item/weapon/stock_parts/cell/incoming_cell, var/mob/user)
	..()
	cell = incoming_cell
